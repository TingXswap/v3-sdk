...
import IPeripheryPaymentsWithFee from '@tingswap/v3-periphery/artifacts/contracts/interfaces/IPeripheryPaymentsWithFee.sol/IPeripheryPaymentsWithFee.json'
import { Percent, Token, validateAndParseAddress } from '@tingswap/sdk-core'
