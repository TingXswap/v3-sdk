import { BigintIsh, Token } from '@tingswap/sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from '@tingswap/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
