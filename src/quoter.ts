...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from '@tingswap/sdk-core'
import { encodeRouteToPath, MethodParameters, toHex } from './utils'
import IQuoter from '@tingswap/v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
import IQuoterV2 from '@tingswap/v3-periphery/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'
...
/**
 * Represents the Tingswap V3 QuoterV1 contract with a method for returning the formatted
