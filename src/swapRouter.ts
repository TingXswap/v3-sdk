...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@tingswap/sdk-core'
...
import ISwapRouter from '@tingswap/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
...
/**
 * Represents the Tingswap V3 SwapRouter, and has static methods for helping execute trades.
 */
